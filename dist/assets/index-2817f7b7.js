 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t(E,M){var j=E.length;E.push(M);e:for(;0<j;){var b=j-1>>>1,P=E[b];if(0<i(P,M))E[b]=M,E[j]=P,j=b;else break e}}function n(E){return E.length===0?null:E[0]}function r(E){if(E.length===0)return null;var M=E[0],j=E.pop();if(j!==M){E[0]=j;e:for(var b=0,P=E.length,z=P>>>1;b<z;){var A=2*(b+1)-1,D=E[A],v=A+1,V=E[v];if(0>i(D,j))v<P&&0>i(V,D)?(E[b]=V,E[v]=j,b=v):(E[b]=D,E[A]=j,b=A);else if(v<P&&0>i(V,j))E[b]=V,E[v]=j,b=v;else break e}}return M}function i(E,M){var j=E.sortIndex-M.sortIndex;return j!==0?j:E.id-M.id}if(typeof performance=="object"&&typeof performance.now=="function"){var o=performance;e.unstable_now=function(){return o.now()}}else{var l=Date,a=l.now();e.unstable_now=function(){return l.now()-a}}var u=[],c=[],p=1,h=null,g=3,w=!1,x=!1,S=!1,L=typeof setTimeout=="function"?setTimeout:null,d=typeof clearTimeout=="function"?clearTimeout:null,s=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function f(E){for(var M=n(c);M!==null;){if(M.callback===null)r(c);else if(M.startTime<=E)r(c),M.sortIndex=M.expirationTime,t(u,M);else break;M=n(c)}}function y(E){if(S=!1,f(E),!x)if(n(u)!==null)x=!0,xt(C);else{var M=n(c);M!==null&&Re(y,M.startTime-E)}}function C(E,M){x=!1,S&&(S=!1,d($),$=-1),w=!0;var j=g;try{for(f(M),h=n(u);h!==null&&(!(h.expirationTime>M)||E&&!me());){var b=h.callback;if(typeof b=="function"){h.callback=null,g=h.priorityLevel;var P=b(h.expirationTime<=M);M=e.unstable_now(),typeof P=="function"?h.callback=P:h===n(u)&&r(u),f(M)}else r(u);h=n(u)}if(h!==null)var z=!0;else{var A=n(c);A!==null&&Re(y,A.startTime-M),z=!1}return z}finally{h=null,g=j,w=!1}}var N=!1,R=null,$=-1,Q=5,F=-1;function me(){return!(e.unstable_now()-F<Q)}function fe(){if(R!==null){var E=e.unstable_now();F=E;var M=!0;try{M=R(!0,E)}finally{M?xe():(N=!1,R=null)}}else N=!1}var xe;if(typeof s=="function")xe=function(){s(fe)};else if(typeof MessageChannel<"u"){var We=new MessageChannel,Pe=We.port2;We.port1.onmessage=fe,xe=function(){Pe.postMessage(null)}}else xe=function(){L(fe,0)};function xt(E){R=E,N||(N=!0,xe())}function Re(E,M){$=L(function(){E(e.unstable_now())},M)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(E){E.callback=null},e.unstable_continueExecution=function(){x||w||(x=!0,xt(C))},e.unstable_forceFrameRate=function(E){0>E||125<E?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):Q=0<E?Math.floor(1e3/E):5},e.unstable_getCurrentPriorityLevel=function(){return g},e.unstable_getFirstCallbackNode=function(){return n(u)},e.unstable_next=function(E){switch(g){case 1:case 2:case 3:var M=3;break;default:M=g}var j=g;g=M;try{return E()}finally{g=j}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(E,M){switch(E){case 1:case 2:case 3:case 4:case 5:break;default:E=3}var j=g;g=E;try{return M()}finally{g=j}},e.unstable_scheduleCallback=function(E,M,j){var b=e.unstable_now();switch(typeof j=="object"&&j!==null?(j=j.delay,j=typeof j=="number"&&0<j?b+j:b):j=b,E){case 1:var P=-1;break;case 2:P=250;break;case 5:P=1073741823;break;case 4:P=1e4;break;default:P=5e3}return P=j+P,E={id:p++,callback:M,priorityLevel:E,startTime:j,expirationTime:P,sortIndex:-1},j>b?(E.sortIndex=j,t(c,E),n(u)===null&&E===n(c)&&(S?(d($),$=-1):S=!0,Re(y,j-b))):(E.sortIndex=P,t(u,E),x||w||(x=!0,xt(C))),E},e.unstable_shouldYield=me,e.unstable_wrapCallback=function(E){var M=g;return function(){var j=g;g=M;try{return E.apply(this,arguments)}finally{g=j}}}})(Js);(function(e){e.exports=Js})(Ff);/**
 * @license React
...
`,Hm=()=>m("div",{children:O(Vm,{children:[O("h1",{children:["A B2B ",m("span",{children:"Marketplace"})," for Agric Commodities "]}),m("p",{children:"Sell your commodities to local and international buyers | Buy commodities from anywhere in the world"}),O("div",{children:[m("a",{href:"https://kasuwa.agriarche.com/signup",children:m(Hr,{children:"create Account"})}),m("a",{href:"https://play.google.com/store/apps/details?id=com.kasuwa_v2",children:O(pf,{style:{display:"flex",alignItems:"center"},children:[m("img",{src:"./images/google-play.png",alt:"download kasuwa app on playstore"})," ",m("span",{children:"Get on Playstore"})," "]})})]}),m("img",{src:"./images/globe.png",alt:"kasuwa around the globe"})]})}),Vm=I.header`
...
`,Wm=()=>O(Qm,{children:[m("img",{src:"./images/KASSSS 2.png",alt:"kasuwa farms logo"}),O(Gm,{children:[m("a",{href:"https://kasuwa.agriarche.com/signin",children:m(Ym,{children:"sign in"})}),m("a",{href:"https://kasuwa.agriarche.com/signup",children:m(Km,{children:"create Account"})})]})]}),Qm=I.nav`
  background: var(--color-white);
...
`;function qm(){const[e,t]=Oe.useState(0),[n,r]=Oe.useState("one");function i(u){t(u)}const o=I.div`
    display: flex;
    width: fit-content;
...
`,r0=()=>O(i0,{children:[O(l0,{children:[O(Lo,{style:{textAlign:"left"},children:["See how it",m("br",{})," works"]}),m("p",{children:"Get a First-Hand Look at the Power of Our B2B Agricultural Marketplace. With our product demo, you can experience the full range of features and benefits designed to streamline your business and drive success."}),m("a",{href:"https://kasuwa.agriarche.com/signup",children:m(a0,{children:"Get Started"})})]}),m(u0,{children:m(o0,{children:m("iframe",{width:"100%","border-radius":"10px",height:"100%",src:"https://www.youtube-nocookie.com/embed/mFiED9Ym9TI",title:"YouTube video player",frameBorder:"0",allow:"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share",allowFullscreen:!0})})})]}),i0=I.div`
...
*,*::after, *::before{
box-sizing: border-box;
}`,O(c0,{children:[O(d0,{children:[m("h2",{children:"Ready To Get Started"}),m("p",{children:"Get started now and experience the benefits of quick, easy and secure transactions all in one place"})]}),O(f0,{children:[O(Us,{children:[m("img",{src:"./images/sellerconnect.svg",alt:"kasuwa farms sellersconnect"}),m("h5",{children:"Sign up as a Seller"}),m("p",{children:"Sign up as a seller on our B2B marketplace and connect with buyers from around the world"}),m(Fs,{children:O("a",{href:"https://kasuwa.agriarche.com/signup",children:[m("sapn",{children:"Sign Up"}),m("img",{style:{width:"11px",height:"7px"},src:"./images/arrow.svg",alt:"arrow btn link to signup seller"})]})})]}),O(Us,{children:[m("img",{src:"./images/buyerconnect.svg",alt:"buyersconnect"}),m("h5",{children:"Sign up as a Buyer"}),m("p",{children:"Get Direct Access to Agric commodities on our B2B Agric Marketplace and enjoy a seamless and efficient trading"}),m(Fs,{children:O("a",{href:"https://kasuwa.agriarche.com/signup",children:[m("sapn",{children:"Sign Up"}),m("img",{style:{width:"11px",height:"7px"},src:"./images/arrow.svg",alt:"arrow btn link to signup as buyer"})]})})]})]})]})),c0=I.div`
margin:400px 140px auto 140px;
width:auto;
height:fit-content;
...
`;const p0=()=>O(h0,{children:[m("h2",{children:"Our Partners"}),O(m0,{children:[m(g0,{style:{width:"182px",height:"57px"},src:"./images/logo2.svg",alt:"united agency for international development logo"}),m(v0,{style:{width:"150px",height:"57px"},src:"./images/logomcn.svg",alt:"mercy corps logo"}),m(y0,{style:{width:"203px",height:"57px"},src:"./images/logoifdc.svg",alt:"IFDC logo"}),m(x0,{style:{width:"162px",height:"70px"},src:"./images/logo1.svg",alt:"NCX logo"}),m(w0,{style:{width:"73px",height:"88px"},src:"./images/logofcmb.svg",alt:"FCMB logo"}),m(S0,{style:{width:"149px",height:"82px"},src:"./images/logofeedthefuture.svg",alt:"feed the futere logo"})]})]}),h0=I.div`
text-align:center;
margin:200px auto;
width:100%;
h2{
...
`,k0=()=>O(E0,{children:[O(C0,{children:[O(Lo,{children:[" Are You an ",m(Bs,{children:"Aggregator"}),m("br",{}),"or a ",m(Bs,{children:"Seller"})," of Agric",m("br",{})," Commodities?"]}),O(_0,{children:[m("a",{href:"https://kasuwa.agriarche.com/signup",children:m(Hr,{children:"Get Started"})}),m("a",{href:"https://play.google.com/store/apps/details?id=com.kasuwa_v2",children:O(pf,{style:{display:"flex",alignItems:"center"},children:[m("img",{style:{width:"20px"},src:"./images/google-play.png",alt:"download kasuwa app on playstore"})," ",m("span",{children:"Get on Playstore"})]})})]}),O(P0,{children:[O("div",{children:[m("img",{src:"./images/service1.svg",alt:"kasuwa farms access quick markets image"}),m("h3",{children:"Access Quick Markets"}),m("p",{children:" Connect with a diverse range of commodities and markets, streamline your operations, and drive growth for your business"})]}),O("div",{children:[m("img",{src:"./images/service5.svg",alt:"kasuwa farms wallet icon"}),m("h3",{children:"Virtual Wallet"}),m("p",{children:"  Our virtual wallet provides you with a secure, convenient, and streamlined way to manage your transactions and payments"})]}),O("div",{children:[m("img",{src:"./images/service4.svg",alt:"kasuwa farms logistics tracking icon"}),m("h3",{children:"Logistics Tracking"}),m("p",{children:"Bringing Transparency to Agriculture Supply Chain, logistics Tracking keeps you in the loop from start to finish."})]}),O("div",{children:[m("img",{src:"./images/transaction.png",alt:"kasuwa farms transaction/creadit card icon"}),m("h3",{children:"Transaction/Credit History"}),m("p",{children:"Get a clear picture of your financial history, manage your payments and credits effectively"})]}),O("div",{children:[m("img",{src:"./images/service3.svg",alt:"kasuwa farms personal data security icon"}),m("h3",{children:"Personal data security"}),m("p",{children:"We ensure your digital information is protected from unauthorized users and cyber attacks."})]}),O("div",{children:[m("img",{src:"./images/customersupport.png",alt:"kasuwa farms customer support"}),m("h3",{children:"24/7 Customer Support"}),m("p",{children:"Our dedicated customer care team is here to assist you around the clock"})]})]})]}),O(z0,{children:[m("img",{style:{position:"absolute",top:"65px",left:"0px",maxHeight:"100%",maxWidth:"400px"},src:"./images/Home Screen 1.svg",alt:"kasuwa farms mobile app"}),m("img",{src:"./images/Kasuwa Web Mockup.svg",alt:"kasuwa farms web app"})]})]}),C0=I.div`
margin-right:50px;
@media (max-width: 1000px) {
    margin-right:0px;
    }
...
img+img{
    ...
    max-width:100%;
    // margin-top:2000px;
`,N0=()=>O($0,{children:[m(A0,{children:m("img",{src:"./images/globe.svg",alt:"access realcommodities data from kasuwa farms"})}),O("div",{style:{marginTop:"-40px"},children:[m("h3",{children:"Access real time market information for commodities"}),m("p",{children:"Stay Ahead of the Game in Agriculture, Access Real-Time Market Information for Commodities. Stay informed and make informed decisions with up-to-date, real-time information on market trends, prices, and more."}),O("a",{href:"https://kasuwa.agriarche.com/signin",children:[m("span",{children:"Make a Request "}),m("img",{style:{width:"10px",height:"15px",marginLeft:"15px"},src:"./images/arrowsmallest.png",alt:"arrow btn"})]})]})]}),$0=I.div`
display:flex;
justify-content:space-between;
flex-wrap:wrap;
gap:5%;
...
`,cl=(e=!1)=>{const[t,n]=Oe.useState(e);return[t,()=>n(i=>!i)]},T0=()=>{const[e,t]=cl(),[n,r]=cl(),[i,o]=cl(),l={display:"flex",justifyContent:"space-between",placeItems:"center",alignContent:"center",paddingBlock:"50px",marginBottom:"30px",cursor:"pointer"};return O(R0,{children:[m("h2",{children:"Frequently Asked Questions"}),O("div",{children:[O("div",{style:{borderBottom:"2px solid #6A6A6A"},children:[O("div",{style:l,onClick:t,children:[m("h3",{children:"What is Kasuwa?"}),e?m("img",{src:"./images/arrowroundedup.svg",alt:""}):m("img",{src:"./images/arrowroundedown.svg",alt:""})]}),m(lr,{children:e?m("p",{children:"The Agricultural Marketplace Kasuwa is the marketplace for agric commodities. A platform that offers payment, logistics, tracking and financial services."}):""})]}),O("div",{style:{borderBottom:"2px solid #6A6A6A"},children:[O("div",{style:l,onClick:r,children:[m("h3",{children:"How to create an order on Kasuwa?"}),n?m("img",{src:"./images/arrowroundedup.svg",alt:""}):m("img",{src:"./images/arrowroundedown.svg",alt:""})]}),m(lr,{children:n?m("p",{children:"The Agricultural Marketplace Kasuwa is the marketplace for agric commodities. A platform that offers payment, logistics, tracking and financial services."}):""})]}),O("div",{style:{borderBottom:"2px solid #6A6A6A"},children:[O("div",{style:l,onClick:o,children:[m("h3",{children:"How to delete a created order?"}),e?m("img",{src:"./images/arrowroundedup.svg",alt:""}):m("img",{src:"./images/arrowroundedown.svg",alt:""})]}),m(lr,{children:i?m("p",{children:"The Agricultural Marketplace Kasuwa is the marketplace for agric commodities. A platform that offers payment, logistics, tracking and financial services."}):""})]})]})]})},R0=I.div`
...
`,L0=()=>O(O0,{children:[m("div",{children:m("p",{children:"© Agriarche Limited. All rights reserved"})}),m("div",{children:O(I0,{children:[m("a",{href:"#",children:m("img",{src:"./images/iconfacebook.png",alt:"facebook icon"})}),m("a",{href:"#",children:m("img",{src:"./images/icontwiter.png",alt:"twitter icon"})}),m("a",{href:"#",children:m("img",{src:"./images/iconinsta.png",alt:"instagram icon"})})]})})]}),O0=I.div`
display:flex;
justify-content:space-between;
padding:50px 150px;
...
`;function M0({details:e}){return m(lr,{children:e.increase>=0?O(Hs,{children:[O("div",{children:[O("strong",{style:{fontSize:"25px"},children:[e.name," "]}),m("span",{style:{color:"#00EE76",fontSize:"20px"},children:" ▲ "}),O("span",{style:{color:"#00EE76"},children:["+",`${e.increase}%`]})]}),O("div",{style:{fontSize:"20px"},children:["₦",e.price]})]}):O(Hs,{children:[O("div",{children:[m("strong",{style:{fontSize:"25px"},children:e.name}),m("span",{style:{color:"#F43249",fontSize:"20px"},children:" ▼  "}),m("span",{style:{color:"#F43249"},children:`${e.increase}%`})]}),O("div",{style:{fontSize:"20px"},children:["₦",e.price]})]})})}const Hs=I.div`
// background:red;
`;function j0(){let e=(r,i,o)=>{const l=(p,h)=>(h-p)/p*100;let a=r.map((p,h)=>l(p,i[h])),u=-1;return o.map(p=>(u++,{name:p.name,price:p.price,increase:a[u].toFixed(2)}))};function t(){let r=[{name:"maize",price:142},{name:"rice",price:248},{name:"cocoa",price:745},{name:"sorghum",price:82},{name:"groundnut",price:184},{name:"wheat",price:70}],i=[{name:"maize",price:30},{name:"rice",price:188},{name:"cocoa",price:780},{name:"sorghum",price:302},{name:"groundnut",price:487},{name:"wheat",price:20}],o=r.map(a=>a.price),l=i.map(a=>a.price);return e(o,l,i)}let n=t();return m(F0,{children:n.map(r=>m(M0,{details:r}))})}let D0=Um`
    0% {
...
`;function U0(){return O("div",{children:[m(j0,{}),m(Wm,{}),m(Hm,{}),m(bm,{}),m(k0,{}),m(r0,{}),m(s0,{}),m(p0,{}),m(N0,{}),m(T0,{}),m(L0,{})]})}dl.createRoot(document.getElementById("root")).render(m(Vn.StrictMode,{children:m(U0,{})}));
