...
`,Wm=()=>p("div",{children:R(Qm,{children:[R("h1",{children:["A B2B ",p("span",{children:"Marketplace"})," for Agric Commodities "]}),p("p",{children:"Sell your commodities to local and international buyers | Buy commodities from anywhere in the world"}),R("div",{children:[p("a",{href:"https://kasuwa.agriarche.com/signup",children:p(Hr,{children:"create Account"})}),p("a",{target:"_blank",href:"https://play.google.com/store/apps/details?id=com.kasuwa_v2",children:R(gf,{children:[p("img",{src:"./images/google-play.png",alt:"download kasuwa app on playstore"})," ",p("span",{children:"Get on Playstore"})," "]})})]}),p("img",{src:"./images/globe.png",alt:"kasuwa around the globe"})]})}),Qm=I.header`
...
`,Gm=()=>R(Km,{children:[p("img",{src:"./images/KASSSS 2.png",alt:"kasuwa farms logo"}),R(Ym,{children:[p("a",{href:"https://kasuwa.agriarche.com/signin",children:p(mf,{children:"sign in"})}),p("a",{href:"https://kasuwa.agriarche.com/signup",children:p(Xm,{children:"create Account"})})]})]}),Km=I.nav`
  background: var(--color-white);
...
`,i0=()=>R(o0,{children:[R(a0,{children:[R(Lo,{style:{textAlign:"left"},children:["See how it",p("br",{})," works"]}),p("p",{children:"Get a First-Hand Look at the Power of Our B2B Agricultural Marketplace. With our product demo, you can experience the full range of features and benefits designed to streamline your business and drive success."}),p("a",{href:"https://kasuwa.agriarche.com/signup",children:p(u0,{children:"Get Started"})})]}),p(s0,{children:p(l0,{children:p("iframe",{width:"100%","border-radius":"10px",height:"100%",src:"https://www.youtube.com/embed/-QdIcyIHZF0",title:"brief kasuwa overview",frameborder:"0",allow:"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share",allowFullscreen:!0})})})]}),o0=I.div`
...
*,*::after, *::before{
box-sizing: border-box;
}`,R(d0,{children:[R(f0,{children:[p("h2",{children:"Ready To Get Started"}),p("p",{children:"Get started now and experience the benefits of quick, easy and secure transactions all in one place"})]}),R(p0,{children:[R(Hs,{children:[p(Fs,{src:"./images/sellerconnect.svg",alt:"kasuwa farms sellersconnect"}),p("h5",{children:"Sign up as a Seller"}),p("p",{children:"Sign up as a seller on our B2B marketplace and connect with buyers from around the world"}),p(Bs,{children:R("a",{href:"https://kasuwa.agriarche.com/signup",children:[p("sapn",{children:"Sign Up"}),p(Us,{src:"./images/arrow.svg",alt:"arrow btn link to signup seller"})]})})]}),R(Hs,{children:[p(Fs,{src:"./images/buyerconnect.svg",alt:"buyersconnect"}),p("h5",{children:"Sign up as a Buyer"}),p("p",{children:"Get Direct Access to Agric commodities on our B2B Agric Marketplace and enjoy a seamless and efficient trading"}),p(Bs,{children:R("a",{href:"https://kasuwa.agriarche.com/signup",children:[p("sapn",{children:"Sign Up"}),p(Us,{src:"./images/arrow.svg",alt:"arrow btn link to signup as buyer"})]})})]})]})]})),d0=I.div`
  margin: 200px 140px auto 140px;
  width: auto;
  height: fit-content;
...
`;I.div``;const h0=()=>R(m0,{children:[p("h2",{children:"Our Partners"}),R(g0,{children:[p(v0,{style:{width:"182px",height:"57px"},src:"./images/logo2.svg",alt:"united agency for international development logo"}),p(y0,{style:{width:"150px",height:"57px"},src:"./images/logomcn.svg",alt:"mercy corps logo"}),p(x0,{style:{width:"203px",height:"57px"},src:"./images/logoifdc.svg",alt:"IFDC logo"}),p(w0,{style:{width:"162px",height:"70px"},src:"./images/logo1.svg",alt:"NCX logo"}),p(k0,{style:{width:"73px",height:"88px"},src:"./images/logofcmb.svg",alt:"FCMB logo"}),p(S0,{style:{width:"149px",height:"82px"},src:"./images/logofeedthefuture.svg",alt:"feed the futere logo"})]})]}),m0=I.div`
  text-align: center;
...
`,C0=()=>R(_0,{children:[R(E0,{children:[R(Lo,{children:[" ","Are You an ",p(Vs,{children:"Aggregator "}),p("br",{}),"or a ",p(Vs,{children:"Seller"})," of Agric",p("br",{})," Commodities?"]}),p(z0,{children:R("div",{children:[p("a",{href:"https://kasuwa.agriarche.com/signup",children:p(Hr,{children:"Get Started"})}),p("a",{href:"https://play.google.com/store/apps/details?id=com.kasuwa_v2",children:R(gf,{children:[p("img",{src:"./images/google-play.png",alt:"download kasuwa app on playstore"})," ",p("span",{children:"Get on Playstore"})]})})]})}),R(P0,{children:[R("div",{children:[p("img",{src:"./images/service1.svg",alt:"kasuwa farms access quick markets image"}),p("h3",{children:"Access Quick Markets"}),R("p",{children:[" ","Connect with a diverse range of commodities and markets, streamline your operations, and drive growth for your business"]})]}),R("div",{children:[p("img",{src:"./images/service5.svg",alt:"kasuwa farms wallet icon"}),p("h3",{children:"Virtual Wallet"}),R("p",{children:[" ","Our virtual wallet provides you with a secure, convenient, and streamlined way to manage your transactions and payments"]})]}),R("div",{children:[p("img",{src:"./images/service4.svg",alt:"kasuwa farms logistics tracking icon"}),p("h3",{children:"Logistics Tracking"}),p("p",{children:"Bringing Transparency to Agriculture Supply Chain, logistics Tracking keeps you in the loop from start to finish."})]}),R("div",{children:[p("img",{src:"./images/transaction.png",alt:"kasuwa farms transaction/creadit card icon"}),p("h3",{children:"Transaction/Credit History"}),p("p",{children:"Get a clear picture of your financial history, manage your payments and credits effectively"})]}),R("div",{children:[p("img",{src:"./images/service3.svg",alt:"kasuwa farms personal data security icon"}),p("h3",{children:"Personal data security"}),p("p",{children:"We ensure your digital information is protected from unauthorized users and cyber attacks."})]}),R("div",{children:[p("img",{src:"./images/customersupport.png",alt:"kasuwa farms customer support"}),p("h3",{children:"24/7 Customer Support"}),p("p",{children:"Our dedicated customer care team is here to assist you around the clock"})]})]})]}),R(A0,{children:[p("img",{style:{position:"absolute",top:"65px",left:"0px",maxHeight:"100%",maxWidth:"400px"},src:"./images/Home Screen 1.svg",alt:"kasuwa farms mobile app"}),p("img",{src:"./images/Kasuwa Web Mockup.svg",alt:"kasuwa farms web app"})]})]}),E0=I.div`
  margin-right: 50px;
  @media (max-width: 1000px) {
    margin-right: 0px;
    // background:green;
...
img+img{
    ...
    max-width:100%;
    // margin-top:2000px;
`,N0=()=>R($0,{children:[p(T0,{children:p("img",{src:"./images/globe.svg",alt:"access realcommodities data from kasuwa farms"})}),R("div",{children:[p("h3",{children:"Access real time market information for commodities"}),p("p",{children:"Stay Ahead of the Game in Agriculture, Access Real-Time Market Information for Commodities. Stay informed and make informed decisions with up-to-date, real-time information on market trends, prices, and more."}),p("div",{children:R("a",{href:"https://kasuwa.agriarche.com/signin",children:[p("span",{children:"Make a Request "}),p("img",{style:{width:"10px",height:"15px",marginLeft:"15px"},src:"./images/arrowsmallest.png",alt:"arrow btn"})]})})]})]}),$0=I.div`
display:flex;
justify-content:space-between;
flex-wrap:wrap;
gap:12%;
...
`,T0=I.div`
  ...
  @media (max-width: 450px) {
    // display:none;
`,cl=(e=!1)=>{const[t,n]=he.useState(e);return[t,()=>n(i=>!i)]},R0=()=>{const[e,t]=cl(),[n,r]=cl(),[i,o]=cl(),l={display:"flex",justifyContent:"space-between",placeItems:"center",alignContent:"center",paddingBlock:"50px",marginBottom:"30px",cursor:"pointer"};return R(L0,{children:[p("h2",{children:"Frequently Asked Questions"}),R("div",{children:[R("div",{style:{borderBottom:"2px solid #6A6A6A"},children:[R("div",{style:l,onClick:t,children:[p("h3",{children:"What is Kasuwa?"}),e?p("img",{src:"./images/arrowroundedup.svg",alt:""}):p("img",{src:"./images/arrowroundedown.svg",alt:""})]}),p(An,{children:e?p("p",{children:"The Agricultural Marketplace Kasuwa is the marketplace for agric commodities. A platform that offers payment, logistics, tracking and financial services."}):""})]}),R("div",{style:{borderBottom:"2px solid #6A6A6A"},children:[R("div",{style:l,onClick:r,children:[p("h3",{children:"How to create an order on Kasuwa?"}),n?p("img",{src:"./images/arrowroundedup.svg",alt:""}):p("img",{src:"./images/arrowroundedown.svg",alt:""})]}),p(An,{children:n?p("p",{children:"The Agricultural Marketplace Kasuwa is the marketplace for agric commodities. A platform that offers payment, logistics, tracking and financial services."}):""})]}),R("div",{style:{borderBottom:"2px solid #6A6A6A"},children:[R("div",{style:l,onClick:o,children:[p("h3",{children:"How to delete a created order?"}),e?p("img",{src:"./images/arrowroundedup.svg",alt:""}):p("img",{src:"./images/arrowroundedown.svg",alt:""})]}),p(An,{children:i?p("p",{children:"The Agricultural Marketplace Kasuwa is the marketplace for agric commodities. A platform that offers payment, logistics, tracking and financial services."}):""})]})]})]})},L0=I.div`
...
`,O0=()=>R(I0,{children:[p("div",{children:p("p",{children:"© Agriarche Limited. All rights reserved"})}),p("div",{children:R(M0,{children:[p("a",{href:"https://facebook.com/kasuwangr",children:p("img",{src:"./images/iconfacebook.png",alt:"facebook icon"})}),p("a",{href:"https://twitter.com/Kasuwangr",children:p("img",{src:"./images/icontwiter.png",alt:"twitter icon"})}),p("a",{href:"https://www.instagram.com/kasuwangr/",children:p("img",{src:"./images/iconinsta.png",alt:"instagram icon"})}),p("a",{href:"https://www.linkedin.com/company/kasuwangr/",children:p("img",{style:{width:"21px"},src:"./images/linkedin.png",alt:"linkedin icon"})})]})})]}),I0=I.div`
display:flex;
justify-content:space-between;
padding:50px 150px;
...
`;function j0({price:e,percentage:t,name:n}){return p(An,{children:t>=0?R(Ws,{children:[R("div",{style:{display:"flex",alignItems:"center",justifyContent:"center"},children:[R("strong",{style:{fontSize:"25px"},children:[n," "]}),p("span",{style:{color:"#00EE76",fontSize:"20px"},children:" ▲ "}),R("span",{style:{color:"#00EE76"},children:["+",`${t}%`]})]}),R("div",{style:{fontSize:"20px"},children:["₦",e]})]}):R(Ws,{children:[R("div",{style:{display:"flex",alignItems:"center",justifyContent:"center"},children:[p("strong",{style:{fontSize:"25px"},children:n}),p("span",{style:{color:"#F43249",fontSize:"20px"},children:" ▼  "}),p("span",{style:{color:"#F43249"},children:`${t}%`})]}),R("div",{style:{fontSize:"20px"},children:["₦",e]})]})})}const Ws=I.div`
display:flex;
flex-direction:column;
// background:red;
...
`;function D0(){const[e,t]=he.useState([]),[n,r]=he.useState({}),[i,o]=he.useState(!0);function l(){fetch("/public").then(a=>a.json()).then(a=>{let u=a[0].commodities,c=a[1].commodities;const g=(w,x)=>((w-x)/x*100).toFixed(2);let m=[],h=[];for(let w=0;w<u.length;w++){let x=!1;for(let k=0;k<c.length;k++)if(u[w].name==c[k].name){if(x)break;m[c[k].name]=g(u[w].price,c[k].price),h[c[k].name]=u[w].price,x=!0}}t(h),u.map(w=>w.price),c.map(w=>w.price),r(m),o(!1)}).catch(a=>{console.log(a)})}return he.useEffect(()=>{l()},[]),p(An,{children:R(U0,{commodities:e,commodityPercentage:n,children:[Object.keys(n).map(a=>p(j0,{name:a,price:e[a],percentage:n[a]})),R("div",{style:{fontSize:"20px",color:"#6A6A6A"},children:[i&&"Loading..."," "]}),R("div",{style:{fontSize:"20px",color:"#6A6A6A"},children:[i&&"Loading..."," "]}),R("div",{style:{fontSize:"20px",color:"#6A6A6A"},children:[i&&"Loading..."," "]}),R("div",{style:{fontSize:"20px",color:"#6A6A6A"},children:[i&&"Loading..."," "]})]})})}let F0=Vm`
    0% {
...
`;function B0(){return R("div",{children:[p(D0,{}),p(Gm,{}),p(Wm,{}),p(e0,{}),p(C0,{}),p(i0,{}),p(c0,{}),p(h0,{}),p(N0,{}),p(R0,{}),p(O0,{})]})}dl.createRoot(document.getElementById("root")).render(p(Wn.StrictMode,{children:p(B0,{})}));
