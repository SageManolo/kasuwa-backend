...
`,Wm=()=>m("div",{children:R(Qm,{children:[R("h1",{children:["A B2B ",m("span",{children:"Marketplace"})," for Agric Commodities "]}),m("p",{children:"Sell your commodities to local and international buyers | Buy commodities from anywhere in the world"}),R("div",{children:[m("a",{href:"https://kasuwa.agriarche.com/signup",children:m(Hr,{children:"create Account"})}),m("a",{target:"_blank",href:"https://play.google.com/store/apps/details?id=com.kasuwa_v2",children:R(gf,{style:{display:"flex",alignItems:"center"},children:[m("img",{src:"./images/google-play.png",alt:"download kasuwa app on playstore"})," ",m("span",{children:"Get on Playstore"})," "]})})]}),m("img",{src:"./images/globe.png",alt:"kasuwa around the globe"})]})}),Qm=I.header`
...
`,Gm=()=>R(Km,{children:[m("img",{src:"./images/KASSSS 2.png",alt:"kasuwa farms logo"}),R(Ym,{children:[m("a",{href:"https://kasuwa.agriarche.com/signin",children:m(mf,{children:"sign in"})}),m("a",{href:"https://kasuwa.agriarche.com/signup",children:m(Xm,{children:"create Account"})})]})]}),Km=I.nav`
  background: var(--color-white);
...
*,*::after, *::before{
box-sizing: border-box;
}`,R(d0,{children:[R(f0,{children:[m("h2",{children:"Ready To Get Started"}),m("p",{children:"Get started now and experience the benefits of quick, easy and secure transactions all in one place"})]}),R(p0,{children:[R(Hs,{children:[m(Fs,{src:"./images/sellerconnect.svg",alt:"kasuwa farms sellersconnect"}),m("h5",{children:"Sign up as a Seller"}),m("p",{children:"Sign up as a seller on our B2B marketplace and connect with buyers from around the world"}),m(Bs,{children:R("a",{href:"https://kasuwa.agriarche.com/signup",children:[m("sapn",{children:"Sign Up"}),m(Us,{src:"./images/arrow.svg",alt:"arrow btn link to signup seller"})]})})]}),R(Hs,{children:[m(Fs,{src:"./images/buyerconnect.svg",alt:"buyersconnect"}),m("h5",{children:"Sign up as a Buyer"}),m("p",{children:"Get Direct Access to Agric commodities on our B2B Agric Marketplace and enjoy a seamless and efficient trading"}),m(Bs,{children:R("a",{href:"https://kasuwa.agriarche.com/signup",children:[m("sapn",{children:"Sign Up"}),m(Us,{src:"./images/arrow.svg",alt:"arrow btn link to signup as buyer"})]})})]})]})]})),d0=I.div`
  margin: 200px 140px auto 140px;
  width: auto;
  height: fit-content;
...
`;I.div``;const h0=()=>R(m0,{children:[m("h2",{children:"Our Partners"}),R(g0,{children:[m(v0,{style:{width:"182px",height:"57px"},src:"./images/logo2.svg",alt:"united agency for international development logo"}),m(y0,{style:{width:"150px",height:"57px"},src:"./images/logomcn.svg",alt:"mercy corps logo"}),m(x0,{style:{width:"203px",height:"57px"},src:"./images/logoifdc.svg",alt:"IFDC logo"}),m(w0,{style:{width:"162px",height:"70px"},src:"./images/logo1.svg",alt:"NCX logo"}),m(k0,{style:{width:"73px",height:"88px"},src:"./images/logofcmb.svg",alt:"FCMB logo"}),m(S0,{style:{width:"149px",height:"82px"},src:"./images/logofeedthefuture.svg",alt:"feed the futere logo"})]})]}),m0=I.div`
text-align:center;
margin:150px auto;
width:100%;
...
`,C0=()=>R(_0,{children:[R(E0,{children:[R(Lo,{children:[" ","Are You an ",m(Vs,{children:"Aggregator "}),m("br",{}),"or a ",m(Vs,{children:"Seller"})," of Agric",m("br",{})," Commodities?"]}),R(z0,{children:[m("a",{href:"https://kasuwa.agriarche.com/signup",children:m(Hr,{children:"Get Started"})}),m("a",{href:"https://play.google.com/store/apps/details?id=com.kasuwa_v2",children:R(gf,{style:{display:"flex",alignItems:"center"},children:[m("img",{style:{width:"20px"},src:"./images/google-play.png",alt:"download kasuwa app on playstore"})," ",m("span",{children:"Get on Playstore"})]})})]}),R(P0,{children:[R("div",{children:[m("img",{src:"./images/service1.svg",alt:"kasuwa farms access quick markets image"}),m("h3",{children:"Access Quick Markets"}),R("p",{children:[" ","Connect with a diverse range of commodities and markets, streamline your operations, and drive growth for your business"]})]}),R("div",{children:[m("img",{src:"./images/service5.svg",alt:"kasuwa farms wallet icon"}),m("h3",{children:"Virtual Wallet"}),R("p",{children:[" ","Our virtual wallet provides you with a secure, convenient, and streamlined way to manage your transactions and payments"]})]}),R("div",{children:[m("img",{src:"./images/service4.svg",alt:"kasuwa farms logistics tracking icon"}),m("h3",{children:"Logistics Tracking"}),m("p",{children:"Bringing Transparency to Agriculture Supply Chain, logistics Tracking keeps you in the loop from start to finish."})]}),R("div",{children:[m("img",{src:"./images/transaction.png",alt:"kasuwa farms transaction/creadit card icon"}),m("h3",{children:"Transaction/Credit History"}),m("p",{children:"Get a clear picture of your financial history, manage your payments and credits effectively"})]}),R("div",{children:[m("img",{src:"./images/service3.svg",alt:"kasuwa farms personal data security icon"}),m("h3",{children:"Personal data security"}),m("p",{children:"We ensure your digital information is protected from unauthorized users and cyber attacks."})]}),R("div",{children:[m("img",{src:"./images/customersupport.png",alt:"kasuwa farms customer support"}),m("h3",{children:"24/7 Customer Support"}),m("p",{children:"Our dedicated customer care team is here to assist you around the clock"})]})]})]}),R(A0,{children:[m("img",{style:{position:"absolute",top:"65px",left:"0px",maxHeight:"100%",maxWidth:"400px"},src:"./images/Home Screen 1.svg",alt:"kasuwa farms mobile app"}),m("img",{src:"./images/Kasuwa Web Mockup.svg",alt:"kasuwa farms web app"})]})]}),E0=I.div`
  margin-right: 50px;
  @media (max-width: 1000px) {
    margin-right: 0px;
  }
...
`,O0=()=>R(I0,{children:[m("div",{children:m("p",{children:"© Agriarche Limited. All rights reserved"})}),m("div",{children:R(M0,{children:[m("a",{href:"https://facebook.com/kasuwangr",children:m("img",{src:"./images/iconfacebook.png",alt:"facebook icon"})}),m("a",{href:"https://twitter.com/Kasuwangr",children:m("img",{src:"./images/icontwiter.png",alt:"twitter icon"})}),m("a",{href:"https://www.instagram.com/kasuwangr/",children:m("img",{src:"./images/iconinsta.png",alt:"instagram icon"})})]})})]}),I0=I.div`
display:flex;
justify-content:space-between;
padding:50px 150px;
...
`;function D0(){const[e,t]=he.useState([]),[n,r]=he.useState({}),[i,o]=he.useState(!0);function l(){fetch("https://kasuwaapp7.onrender.com/public").then(a=>a.json()).then(a=>{let u=a[0].commodities,c=a[1].commodities;const g=(w,x)=>((w-x)/x*100).toFixed(2);let h=[],p=[];for(let w=0;w<u.length;w++){let x=!1;for(let k=0;k<c.length;k++)if(u[w].name==c[k].name){if(x)break;h[c[k].name]=g(u[w].price,c[k].price),p[c[k].name]=u[w].price,x=!0}}t(p),console.log(p),u.map(w=>w.price),c.map(w=>w.price),r(h),o(!1)}).catch(a=>{console.log(a)})}return he.useEffect(()=>{l()},[]),m(An,{children:R(U0,{commodities:e,commodityPercentage:n,children:[Object.keys(n).map(a=>m(j0,{name:a,price:e[a],percentage:n[a]})),R("div",{style:{fontSize:"20px",color:"#6A6A6A"},children:[i&&"Loading..."," "]}),R("div",{style:{fontSize:"20px",color:"#6A6A6A"},children:[i&&"Loading..."," "]}),R("div",{style:{fontSize:"20px",color:"#6A6A6A"},children:[i&&"Loading..."," "]}),R("div",{style:{fontSize:"20px",color:"#6A6A6A"},children:[i&&"Loading..."," "]})]})})}let F0=Vm`
    0% {
...
`;function B0(){return R("div",{children:[m(D0,{}),m(Gm,{}),m(Wm,{}),m(e0,{}),m(C0,{}),m(i0,{}),m(c0,{}),m(h0,{}),m(N0,{}),m(R0,{}),m(O0,{})]})}dl.createRoot(document.getElementById("root")).render(m(Wn.StrictMode,{children:m(B0,{})}));
