 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t(E,M){var j=E.length;E.push(M);e:for(;0<j;){var b=j-1>>>1,P=E[b];if(0<i(P,M))E[b]=M,E[j]=P,j=b;else break e}}function n(E){return E.length===0?null:E[0]}function r(E){if(E.length===0)return null;var M=E[0],j=E.pop();if(j!==M){E[0]=j;e:for(var b=0,P=E.length,z=P>>>1;b<z;){var A=2*(b+1)-1,D=E[A],v=A+1,V=E[v];if(0>i(D,j))v<P&&0>i(V,D)?(E[b]=V,E[v]=j,b=v):(E[b]=D,E[A]=j,b=A);else if(v<P&&0>i(V,j))E[b]=V,E[v]=j,b=v;else break e}}return M}function i(E,M){var j=E.sortIndex-M.sortIndex;return j!==0?j:E.id-M.id}if(typeof performance=="object"&&typeof performance.now=="function"){var o=performance;e.unstable_now=function(){return o.now()}}else{var l=Date,a=l.now();e.unstable_now=function(){return l.now()-a}}var u=[],c=[],g=1,m=null,p=3,x=!1,w=!1,S=!1,L=typeof setTimeout=="function"?setTimeout:null,d=typeof clearTimeout=="function"?clearTimeout:null,s=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function f(E){for(var M=n(c);M!==null;){if(M.callback===null)r(c);else if(M.startTime<=E)r(c),M.sortIndex=M.expirationTime,t(u,M);else break;M=n(c)}}function y(E){if(S=!1,f(E),!w)if(n(u)!==null)w=!0,xt(C);else{var M=n(c);M!==null&&Le(y,M.startTime-E)}}function C(E,M){w=!1,S&&(S=!1,d($),$=-1),x=!0;var j=p;try{for(f(M),m=n(u);m!==null&&(!(m.expirationTime>M)||E&&!me());){var b=m.callback;if(typeof b=="function"){m.callback=null,p=m.priorityLevel;var P=b(m.expirationTime<=M);M=e.unstable_now(),typeof P=="function"?m.callback=P:m===n(u)&&r(u),f(M)}else r(u);m=n(u)}if(m!==null)var z=!0;else{var A=n(c);A!==null&&Le(y,A.startTime-M),z=!1}return z}finally{m=null,p=j,x=!1}}var N=!1,R=null,$=-1,Q=5,F=-1;function me(){return!(e.unstable_now()-F<Q)}function fe(){if(R!==null){var E=e.unstable_now();F=E;var M=!0;try{M=R(!0,E)}finally{M?we():(N=!1,R=null)}}else N=!1}var we;if(typeof s=="function")we=function(){s(fe)};else if(typeof MessageChannel<"u"){var We=new MessageChannel,ze=We.port2;We.port1.onmessage=fe,we=function(){ze.postMessage(null)}}else we=function(){L(fe,0)};function xt(E){R=E,N||(N=!0,we())}function Le(E,M){$=L(function(){E(e.unstable_now())},M)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(E){E.callback=null},e.unstable_continueExecution=function(){w||x||(w=!0,xt(C))},e.unstable_forceFrameRate=function(E){0>E||125<E?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):Q=0<E?Math.floor(1e3/E):5},e.unstable_getCurrentPriorityLevel=function(){return p},e.unstable_getFirstCallbackNode=function(){return n(u)},e.unstable_next=function(E){switch(p){case 1:case 2:case 3:var M=3;break;default:M=p}var j=p;p=M;try{return E()}finally{p=j}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(E,M){switch(E){case 1:case 2:case 3:case 4:case 5:break;default:E=3}var j=p;p=E;try{return M()}finally{p=j}},e.unstable_scheduleCallback=function(E,M,j){var b=e.unstable_now();switch(typeof j=="object"&&j!==null?(j=j.delay,j=typeof j=="number"&&0<j?b+j:b):j=b,E){case 1:var P=-1;break;case 2:P=250;break;case 5:P=1073741823;break;case 4:P=1e4;break;default:P=5e3}return P=j+P,E={id:g++,callback:M,priorityLevel:E,startTime:j,expirationTime:P,sortIndex:-1},j>b?(E.sortIndex=j,t(c,E),n(u)===null&&E===n(c)&&(S?(d($),$=-1):S=!0,Le(y,j-b))):(E.sortIndex=P,t(u,E),w||x||(w=!0,xt(C))),E},e.unstable_shouldYield=me,e.unstable_wrapCallback=function(E){var M=p;return function(){var j=p;p=M;try{return E.apply(this,arguments)}finally{p=j}}}})(Js);(function(e){e.exports=Js})(Ff);/**
 * @license React
...
`}}}return o}(this)},e}(),Cm=/(a)(d)/gi,Os=function(e){return String.fromCharCode(e+(e>25?39:97))};function ua(e){var t,n="";for(t=Math.abs(e);t>52;t=t/52|0)n=Os(t%52)+n;return(Os(t%52)+n).replace(Cm,"$1-$2")}var zn=function(e,t){for(var n=t.length;n;)e=33*e^t.charCodeAt(--n);return e},nf=function(e){return zn(5381,e)};function rf(e){for(var t=0;t<e.length;t+=1){var n=e[t];if(Ir(n)&&!pu(n))return!1}return!0}var Em=nf("5.3.6"),_m=function(){function e(t,n,r){this.rules=t,this.staticRulesId="",this.isStatic=(r===void 0||r.isStatic)&&rf(t),this.componentId=n,this.baseHash=zn(Em,n),this.baseStyle=r,Xi.registerId(n)}return e.prototype.generateAndInjectStyles=function(t,n,r){var i=this.componentId,o=[];if(this.baseStyle&&o.push(this.baseStyle.generateAndInjectStyles(t,n,r)),this.isStatic&&!r.hash)if(this.staticRulesId&&n.hasNameForId(i,this.staticRulesId))o.push(this.staticRulesId);else{var l=dn(this.rules,t,n,r).join(""),a=ua(zn(this.baseHash,l)>>>0);if(!n.hasNameForId(i,a)){var u=r(l,"."+a,void 0,i);n.insertRules(i,a,u)}o.push(a),this.staticRulesId=a}else{for(var c=this.rules.length,g=zn(this.baseHash,r.hash),m="",p=0;p<c;p++){var x=this.rules[p];if(typeof x=="string")m+=x;else if(x){var w=dn(x,t,n,r),S=Array.isArray(w)?w.join(""):w;g=zn(g,S+p),m+=S}}if(m){var L=ua(g>>>0);if(!n.hasNameForId(i,L)){var d=r(m,"."+L,void 0,i);n.insertRules(i,L,d)}o.push(L)}}return o.join(" ")},e}(),Pm=/^\s*\/\/.*$/gm,zm=[":","[",".","#"];function Nm(e){var t,n,r,i,o=e===void 0?Gt:e,l=o.options,a=l===void 0?Gt:l,u=o.plugins,c=u===void 0?Yi:u,g=new Qh(a),m=[],p=function(S){function L(d){if(d)try{S(d+"}")}catch{}}return function(d,s,f,y,C,N,R,$,Q,F){switch(d){case 1:if(Q===0&&s.charCodeAt(0)===64)return S(s+";"),"";break;case 2:if($===0)return s+"/*|*/";break;case 3:switch($){case 102:case 112:return S(f[0]+s),"";default:return s+(F===0?"/*|*/":"")}case-2:s.split("/*|*/}").forEach(L)}}}(function(S){m.push(S)}),x=function(S,L,d){return L===0&&zm.indexOf(d[n.length])!==-1||d.match(i)?S:"."+t};function w(S,L,d,s){s===void 0&&(s="&");var f=S.replace(Pm,""),y=L&&d?d+" "+L+" { "+f+" }":f;return t=s,n=L,r=new RegExp("\\"+n+"\\b","g"),i=new RegExp("(\\"+n+"\\b){2,}"),g(d||!L?"":L,y)}return g.use([].concat(c,[function(S,L,d){S===2&&d.length&&d[0].lastIndexOf(n)>0&&(d[0]=d[0].replace(r,x))},p,function(S){if(S===-2){var L=m;return m=[],L}}])),w.hash=c.length?c.reduce(function(S,L){return L.name||Br(15),zn(S,L.name)},5381).toString():"",w}var of=Vn.createContext();of.Consumer;var lf=Vn.createContext(),$m=(lf.Consumer,new Xi),sa=Nm();function af(){return ve.useContext(of)||$m}function uf(){return ve.useContext(lf)||sa}var sf=function(){function e(t,n){var r=this;this.inject=function(i,o){o===void 0&&(o=sa);var l=r.name+o.hash;i.hasNameForId(r.id,l)||i.insertRules(r.id,l,o(r.rules,l,"@keyframes"))},this.toString=function(){return Br(12,String(r.name))},this.name=t,this.id="sc-keyframes-"+t,this.rules=n}return e.prototype.getName=function(t){return t===void 0&&(t=sa),this.name+t.hash},e}(),Am=/([A-Z])/,Tm=/([A-Z])/g,Rm=/^ms-/,Lm=function(e){return"-"+e.toLowerCase()};function Is(e){return Am.test(e)?e.replace(Tm,Lm).replace(Rm,"-ms-"):e}var Ms=function(e){return e==null||e===!1||e===""};function dn(e,t,n,r){if(Array.isArray(e)){for(var i,o=[],l=0,a=e.length;l<a;l+=1)(i=dn(e[l],t,n,r))!==""&&(Array.isArray(i)?o.push.apply(o,i):o.push(i));return o}if(Ms(e))return"";if(pu(e))return"."+e.styledComponentId;if(Ir(e)){if(typeof(c=e)!="function"||c.prototype&&c.prototype.isReactComponent||!t)return e;var u=e(t);return dn(u,t,n,r)}var c;return e instanceof sf?n?(e.inject(n,r),e.getName(r)):e:aa(e)?function g(m,p){var x,w,S=[];for(var L in m)m.hasOwnProperty(L)&&!Ms(m[L])&&(Array.isArray(m[L])&&m[L].isCss||Ir(m[L])?S.push(Is(L)+":",m[L],";"):aa(m[L])?S.push.apply(S,g(m[L],L)):S.push(Is(L)+": "+(x=L,(w=m[L])==null||typeof w=="boolean"||w===""?"":typeof w!="number"||w===0||x in Gh?String(w).trim():w+"px")+";"));return p?[p+" {"].concat(S,["}"]):S}(e):e.toString()}var js=function(e){return Array.isArray(e)&&(e.isCss=!0),e};function mu(e){for(var t=arguments.length,n=new Array(t>1?t-1:0),r=1;r<t;r++)n[r-1]=arguments[r];return Ir(e)||aa(e)?js(dn(Ts(Yi,[e].concat(n)))):n.length===0&&e.length===1&&typeof e[0]=="string"?e:js(dn(Ts(e,n)))}var cf=function(e,t,n){return n===void 0&&(n=Gt),e.theme!==n.theme&&e.theme||t||n.theme},Om=/[!"#$%&'()*+,./:;<=>?@[\\\]^`{|}~-]+/g,Im=/(^-|-$)/g;function ul(e){return e.replace(Om,"-").replace(Im,"")}var gu=function(e){return ua(nf(e)>>>0)};function ui(e){return typeof e=="string"&&!0}var ca=function(e){return typeof e=="function"||typeof e=="object"&&e!==null&&!Array.isArray(e)},Mm=function(e){return e!=="__proto__"&&e!=="constructor"&&e!=="prototype"};function jm(e,t,n){var r=e[n];ca(t)&&ca(r)?df(r,t):e[n]=t}function df(e){for(var t=arguments.length,n=new Array(t>1?t-1:0),r=1;r<t;r++)n[r-1]=arguments[r];for(var i=0,o=n;i<o.length;i++){var l=o[i];if(ca(l))for(var a in l)Mm(a)&&jm(e,l[a],a)}return e}var vu=Vn.createContext();vu.Consumer;var sl={};function ff(e,t,n){var r=pu(e),i=!ui(e),o=t.attrs,l=o===void 0?Yi:o,a=t.componentId,u=a===void 0?function(s,f){var y=typeof s!="string"?"sc":ul(s);sl[y]=(sl[y]||0)+1;var C=y+"-"+gu("5.3.6"+y+sl[y]);return f?f+"-"+C:C}(t.displayName,t.parentComponentId):a,c=t.displayName,g=c===void 0?function(s){return ui(s)?"styled."+s:"Styled("+Rs(s)+")"}(e):c,m=t.displayName&&t.componentId?ul(t.displayName)+"-"+t.componentId:t.componentId||u,p=r&&e.attrs?Array.prototype.concat(e.attrs,l).filter(Boolean):l,x=t.shouldForwardProp;r&&e.shouldForwardProp&&(x=t.shouldForwardProp?function(s,f,y){return e.shouldForwardProp(s,f,y)&&t.shouldForwardProp(s,f,y)}:e.shouldForwardProp);var w,S=new _m(n,m,r?e.componentStyle:void 0),L=S.isStatic&&l.length===0,d=function(s,f){return function(y,C,N,R){var $=y.attrs,Q=y.componentStyle,F=y.defaultProps,me=y.foldedComponentIds,fe=y.shouldForwardProp,we=y.styledComponentId,We=y.target,ze=function(D,v,V){D===void 0&&(D=Gt);var _=gt({},v,{theme:D}),ae={};return V.forEach(function(Y){var X,B,Se,De=Y;for(X in Ir(De)&&(De=De(_)),De)_[X]=ae[X]=X==="className"?(B=ae[X],Se=De[X],B&&Se?B+" "+Se:B||Se):De[X]}),[_,ae]}(cf(C,ve.useContext(vu),F)||Gt,C,$),xt=ze[0],Le=ze[1],E=function(D,v,V,_){var ae=af(),Y=uf(),X=v?D.generateAndInjectStyles(Gt,ae,Y):D.generateAndInjectStyles(V,ae,Y);return X}(Q,R,xt),M=N,j=Le.$as||C.$as||Le.as||C.as||We,b=ui(j),P=Le!==C?gt({},C,{},Le):C,z={};for(var A in P)A[0]!=="$"&&A!=="as"&&(A==="forwardedAs"?z.as=P[A]:(fe?fe(A,zs,j):!b||zs(A))&&(z[A]=P[A]));return C.style&&Le.style!==C.style&&(z.style=gt({},C.style,{},Le.style)),z.className=Array.prototype.concat(me,we,E!==we?E:null,C.className,Le.className).filter(Boolean).join(" "),z.ref=M,ve.createElement(j,z)}(w,s,f,L)};return d.displayName=g,(w=Vn.forwardRef(d)).attrs=p,w.componentStyle=S,w.displayName=g,w.shouldForwardProp=x,w.foldedComponentIds=r?Array.prototype.concat(e.foldedComponentIds,e.styledComponentId):Yi,w.styledComponentId=m,w.target=r?e.target:e,w.withComponent=function(s){var f=t.componentId,y=function(N,R){if(N==null)return{};var $,Q,F={},me=Object.keys(N);for(Q=0;Q<me.length;Q++)$=me[Q],R.indexOf($)>=0||(F[$]=N[$]);return F}(t,["componentId"]),C=f&&f+"-"+(ui(s)?s:ul(Rs(s)));return ff(s,gt({},y,{attrs:p,componentId:C}),n)},Object.defineProperty(w,"defaultProps",{get:function(){return this._foldedDefaultProps},set:function(s){this._foldedDefaultProps=r?df({},e.defaultProps,s):s}}),w.toString=function(){return"."+w.styledComponentId},i&&um(w,e,{attrs:!0,componentStyle:!0,displayName:!0,foldedComponentIds:!0,shouldForwardProp:!0,styledComponentId:!0,target:!0,withComponent:!0}),w}var da=function(e){return function t(n,r,i){if(i===void 0&&(i=Gt),!Gi.isValidElementType(r))return Br(1,String(r));var o=function(){return n(r,i,mu.apply(void 0,arguments))};return o.withConfig=function(l){return t(n,r,gt({},i,{},l))},o.attrs=function(l){return t(n,r,gt({},i,{attrs:Array.prototype.concat(i.attrs,l).filter(Boolean)}))},o}(ff,e)};["a","abbr","address","area","article","aside","audio","b","base","bdi","bdo","big","blockquote","body","br","button","canvas","caption","cite","code","col","colgroup","data","datalist","dd","del","details","dfn","dialog","div","dl","dt","em","embed","fieldset","figcaption","figure","footer","form","h1","h2","h3","h4","h5","h6","head","header","hgroup","hr","html","i","iframe","img","input","ins","kbd","keygen","label","legend","li","link","main","map","mark","marquee","menu","menuitem","meta","meter","nav","noscript","object","ol","optgroup","option","output","p","param","picture","pre","progress","q","rp","rt","ruby","s","samp","script","section","select","small","source","span","strong","style","sub","summary","sup","table","tbody","td","textarea","tfoot","th","thead","time","title","tr","track","u","ul","var","video","wbr","circle","clipPath","defs","ellipse","foreignObject","g","image","line","linearGradient","marker","mask","path","pattern","polygon","polyline","radialGradient","rect","stop","svg","text","textPath","tspan"].forEach(function(e){da[e]=da(e)});var Dm=function(){function e(n,r){this.rules=n,this.componentId=r,this.isStatic=rf(n),Xi.registerId(this.componentId+1)}var t=e.prototype;return t.createStyles=function(n,r,i,o){var l=o(dn(this.rules,r,i,o).join(""),""),a=this.componentId+n;i.insertRules(a,a,l)},t.removeStyles=function(n,r){r.clearRules(this.componentId+n)},t.renderStyles=function(n,r,i,o){n>2&&Xi.registerId(this.componentId+n),this.removeStyles(n,i),this.createStyles(n,r,i,o)},e}();function Fm(e){for(var t=arguments.length,n=new Array(t>1?t-1:0),r=1;r<t;r++)n[r-1]=arguments[r];var i=mu.apply(void 0,[e].concat(n)),o="sc-global-"+gu(JSON.stringify(i)),l=new Dm(i,o);function a(c){var g=af(),m=uf(),p=ve.useContext(vu),x=ve.useRef(g.allocateGSInstance(o)).current;return g.server&&u(x,c,g,p,m),ve.useLayoutEffect(function(){if(!g.server)return u(x,c,g,p,m),function(){return l.removeStyles(x,g)}},[x,c,g,p,m]),null}function u(c,g,m,p,x){if(l.isStatic)l.renderStyles(c,cm,m,x);else{var w=gt({},g,{theme:cf(g,p,a.defaultProps)});l.renderStyles(c,w,m,x)}}return Vn.memo(a)}function Um(e){for(var t=arguments.length,n=new Array(t>1?t-1:0),r=1;r<t;r++)n[r-1]=arguments[r];var i=mu.apply(void 0,[e].concat(n)).join(""),o=gu(i);return new sf(o,i)}const I=da,Bm=I.button`
...
// background:red;
`;function j0(){const[e,t]=ve.useState([]),[n,r]=ve.useState({});function i(){fetch("https://kasuwaapp7.onrender.com/public").then(o=>o.json()).then(o=>{let l=o[0].commodities,a=o[1].commodities;const u=(x,w)=>((w-x)/x*100).toFixed(2);let c=[],g=[];for(let x=0;x<l.length;x++){let w=!1;for(let S=0;S<a.length;S++)if(l[x].name==a[S].name){if(w)break;c[a[S].name]=u(l[x].price,a[S].price),g[a[S].name]=a[S].price,w=!0}}console.log("Array3:",c),t(g),console.log("arr4",g),console.log("c0mmodity:",n);let m=l.map(x=>x.price),p=a.map(x=>x.price);console.log(m),console.log(p),r(c)}).catch(o=>{console.log(o)})}return ve.useEffect(()=>{i()},[]),h(F0,{commodities:e,commodityPercentage:n,children:Object.keys(n).map(o=>h(M0,{name:o,price:e[o],percentage:n[o]}))})}let D0=Um`
    0% {
