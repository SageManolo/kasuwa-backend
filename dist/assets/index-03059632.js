 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t(E,M){var j=E.length;E.push(M);e:for(;0<j;){var b=j-1>>>1,P=E[b];if(0<i(P,M))E[b]=M,E[j]=P,j=b;else break e}}function n(E){return E.length===0?null:E[0]}function r(E){if(E.length===0)return null;var M=E[0],j=E.pop();if(j!==M){E[0]=j;e:for(var b=0,P=E.length,z=P>>>1;b<z;){var A=2*(b+1)-1,D=E[A],v=A+1,V=E[v];if(0>i(D,j))v<P&&0>i(V,D)?(E[b]=V,E[v]=j,b=v):(E[b]=D,E[A]=j,b=A);else if(v<P&&0>i(V,j))E[b]=V,E[v]=j,b=v;else break e}}return M}function i(E,M){var j=E.sortIndex-M.sortIndex;return j!==0?j:E.id-M.id}if(typeof performance=="object"&&typeof performance.now=="function"){var o=performance;e.unstable_now=function(){return o.now()}}else{var l=Date,a=l.now();e.unstable_now=function(){return l.now()-a}}var u=[],c=[],g=1,m=null,h=3,w=!1,x=!1,k=!1,L=typeof setTimeout=="function"?setTimeout:null,d=typeof clearTimeout=="function"?clearTimeout:null,s=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function f(E){for(var M=n(c);M!==null;){if(M.callback===null)r(c);else if(M.startTime<=E)r(c),M.sortIndex=M.expirationTime,t(u,M);else break;M=n(c)}}function y(E){if(k=!1,f(E),!x)if(n(u)!==null)x=!0,xt(C);else{var M=n(c);M!==null&&Le(y,M.startTime-E)}}function C(E,M){x=!1,k&&(k=!1,d($),$=-1),w=!0;var j=h;try{for(f(M),m=n(u);m!==null&&(!(m.expirationTime>M)||E&&!me());){var b=m.callback;if(typeof b=="function"){m.callback=null,h=m.priorityLevel;var P=b(m.expirationTime<=M);M=e.unstable_now(),typeof P=="function"?m.callback=P:m===n(u)&&r(u),f(M)}else r(u);m=n(u)}if(m!==null)var z=!0;else{var A=n(c);A!==null&&Le(y,A.startTime-M),z=!1}return z}finally{m=null,h=j,w=!1}}var N=!1,R=null,$=-1,Q=5,F=-1;function me(){return!(e.unstable_now()-F<Q)}function fe(){if(R!==null){var E=e.unstable_now();F=E;var M=!0;try{M=R(!0,E)}finally{M?we():(N=!1,R=null)}}else N=!1}var we;if(typeof s=="function")we=function(){s(fe)};else if(typeof MessageChannel<"u"){var We=new MessageChannel,ze=We.port2;We.port1.onmessage=fe,we=function(){ze.postMessage(null)}}else we=function(){L(fe,0)};function xt(E){R=E,N||(N=!0,we())}function Le(E,M){$=L(function(){E(e.unstable_now())},M)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(E){E.callback=null},e.unstable_continueExecution=function(){x||w||(x=!0,xt(C))},e.unstable_forceFrameRate=function(E){0>E||125<E?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):Q=0<E?Math.floor(1e3/E):5},e.unstable_getCurrentPriorityLevel=function(){return h},e.unstable_getFirstCallbackNode=function(){return n(u)},e.unstable_next=function(E){switch(h){case 1:case 2:case 3:var M=3;break;default:M=h}var j=h;h=M;try{return E()}finally{h=j}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(E,M){switch(E){case 1:case 2:case 3:case 4:case 5:break;default:E=3}var j=h;h=E;try{return M()}finally{h=j}},e.unstable_scheduleCallback=function(E,M,j){var b=e.unstable_now();switch(typeof j=="object"&&j!==null?(j=j.delay,j=typeof j=="number"&&0<j?b+j:b):j=b,E){case 1:var P=-1;break;case 2:P=250;break;case 5:P=1073741823;break;case 4:P=1e4;break;default:P=5e3}return P=j+P,E={id:g++,callback:M,priorityLevel:E,startTime:j,expirationTime:P,sortIndex:-1},j>b?(E.sortIndex=j,t(c,E),n(u)===null&&E===n(c)&&(k?(d($),$=-1):k=!0,Le(y,j-b))):(E.sortIndex=P,t(u,E),x||w||(x=!0,xt(C))),E},e.unstable_shouldYield=me,e.unstable_wrapCallback=function(E){var M=h;return function(){var j=h;h=M;try{return E.apply(this,arguments)}finally{h=j}}}})(Js);(function(e){e.exports=Js})(Ff);/**
 * @license React
...
`,Hm=()=>p("div",{children:O(Vm,{children:[O("h1",{children:["A B2B ",p("span",{children:"Marketplace"})," for Agric Commodities "]}),p("p",{children:"Sell your commodities to local and international buyers | Buy commodities from anywhere in the world"}),O("div",{children:[p("a",{href:"https://kasuwa.agriarche.com/signup",children:p(Hr,{children:"create Account"})}),p("a",{href:"https://play.google.com/store/apps/details?id=com.kasuwa_v2",children:O(pf,{style:{display:"flex",alignItems:"center"},children:[p("img",{src:"./images/google-play.png",alt:"download kasuwa app on playstore"})," ",p("span",{children:"Get on Playstore"})," "]})})]}),p("img",{src:"./images/globe.png",alt:"kasuwa around the globe"})]})}),Vm=I.header`
...
`,Wm=()=>O(Qm,{children:[p("img",{src:"./images/KASSSS 2.png",alt:"kasuwa farms logo"}),O(Gm,{children:[p("a",{href:"https://kasuwa.agriarche.com/signin",children:p(Ym,{children:"sign in"})}),p("a",{href:"https://kasuwa.agriarche.com/signup",children:p(Km,{children:"create Account"})})]})]}),Qm=I.nav`
  background: var(--color-white);
...
`;function qm(){const[e,t]=ve.useState(0),[n,r]=ve.useState("one");function i(u){t(u)}const o=I.div`
  ...
  `,a=I.div`
    ...
    min-width: 370px;
    transition: all 500ms slide-in;
  `;return O("div",{children:[p(a,{children:p(o,{children:Xm.map(u=>p(Zm,{imgdetails:u}))})}),O(l,{children:[p(lr,{children:n=="one"?p("div",{style:{background:"white",border:"1px solid var(--color-primary)"},onClick:()=>{i(-0),r("one")}}):p("div",{style:{background:"orange"},onClick:()=>{i(-0),r("one")}})}),n==="two"?p("div",{style:{background:"white",border:"1px solid var(--color-primary)"},onClick:()=>{i(-90),r("two"),r("one")}}):p("div",{style:{background:"var(--color-primary)"},onClick:()=>{i(-90),r("two"),console.log("orange")}}),n=="three"?p("div",{style:{background:"white",border:"1px solid var(--color-primary)"},onClick:()=>{i(-180),r("three")}}):p("div",{style:{background:"var(--color-primary"},onClick:()=>{i(-180),r("three")}}),n=="four"?p("div",{style:{background:"white",border:"1px solid var(--color-primary)"},onClick:()=>{i(-270),r("four")}}):p("div",{style:{background:"var(--color-primary"},onClick:()=>{i(-270),r("four")}}),n=="five"?p("div",{style:{background:"white",border:"1px solid var(--color-primary)"},onClick:()=>{i(-360),r("five")}}):p("div",{style:{background:"var(--color-primary"},onClick:()=>{i(-360),r("five")}})]})]})}const bm=()=>O(t0,{translateValue:!0,children:[O(Lo,{style:{paddingLeft:"10px"},children:["Buy African ",p(Ds,{children:"Commodities"})," ",p("br",{})," from"," ",p(Ds,{children:"Anywhere"})]}),O(n0,{children:[p("a",{href:"https://kasuwa.agriarche.com/signup",children:p(Hr,{children:"place an order"})}),p("div",{children:p("a",{href:"https://kasuwa.agriarche.com/signup",children:p("img",{src:"./images/Vector (5).svg",alt:"placeorder arrow button"})})})]}),p(e0,{children:p(qm,{})})]}),e0=I.div`
`;I.span`
  // border:1px solid red;
  font-size: 20px;
  font-weight: 1000;
...
`,r0=()=>O(i0,{children:[O(l0,{children:[O(Lo,{style:{textAlign:"left"},children:["See how it",p("br",{})," works"]}),p("p",{children:"Get a First-Hand Look at the Power of Our B2B Agricultural Marketplace. With our product demo, you can experience the full range of features and benefits designed to streamline your business and drive success."}),p("a",{href:"https://kasuwa.agriarche.com/signup",children:p(a0,{children:"Get Started"})})]}),p(u0,{children:p(o0,{children:p("iframe",{width:"100%","border-radius":"10px",height:"100%",src:"https://www.youtube-nocookie.com/embed/mFiED9Ym9TI",title:"YouTube video player",frameBorder:"0",allow:"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share",allowFullscreen:!0})})})]}),i0=I.div`
...
*,*::after, *::before{
box-sizing: border-box;
}`,O(c0,{children:[O(d0,{children:[p("h2",{children:"Ready To Get Started"}),p("p",{children:"Get started now and experience the benefits of quick, easy and secure transactions all in one place"})]}),O(f0,{children:[O(Us,{children:[p("img",{src:"./images/sellerconnect.svg",alt:"kasuwa farms sellersconnect"}),p("h5",{children:"Sign up as a Seller"}),p("p",{children:"Sign up as a seller on our B2B marketplace and connect with buyers from around the world"}),p(Fs,{children:O("a",{href:"https://kasuwa.agriarche.com/signup",children:[p("sapn",{children:"Sign Up"}),p("img",{style:{width:"11px",height:"7px"},src:"./images/arrow.svg",alt:"arrow btn link to signup seller"})]})})]}),O(Us,{children:[p("img",{src:"./images/buyerconnect.svg",alt:"buyersconnect"}),p("h5",{children:"Sign up as a Buyer"}),p("p",{children:"Get Direct Access to Agric commodities on our B2B Agric Marketplace and enjoy a seamless and efficient trading"}),p(Fs,{children:O("a",{href:"https://kasuwa.agriarche.com/signup",children:[p("sapn",{children:"Sign Up"}),p("img",{style:{width:"11px",height:"7px"},src:"./images/arrow.svg",alt:"arrow btn link to signup as buyer"})]})})]})]})]})),c0=I.div`
margin:400px 140px auto 140px;
width:auto;
height:fit-content;
...
`;const p0=()=>O(h0,{children:[p("h2",{children:"Our Partners"}),O(m0,{children:[p(g0,{style:{width:"182px",height:"57px"},src:"./images/logo2.svg",alt:"united agency for international development logo"}),p(v0,{style:{width:"150px",height:"57px"},src:"./images/logomcn.svg",alt:"mercy corps logo"}),p(y0,{style:{width:"203px",height:"57px"},src:"./images/logoifdc.svg",alt:"IFDC logo"}),p(x0,{style:{width:"162px",height:"70px"},src:"./images/logo1.svg",alt:"NCX logo"}),p(w0,{style:{width:"73px",height:"88px"},src:"./images/logofcmb.svg",alt:"FCMB logo"}),p(k0,{style:{width:"149px",height:"82px"},src:"./images/logofeedthefuture.svg",alt:"feed the futere logo"})]})]}),h0=I.div`
text-align:center;
margin:200px auto;
width:100%;
...
`,S0=()=>O(E0,{children:[O(C0,{children:[O(Lo,{children:[" Are You an ",p(Bs,{children:"Aggregator"}),p("br",{}),"or a ",p(Bs,{children:"Seller"})," of Agric",p("br",{})," Commodities?"]}),O(_0,{children:[p("a",{href:"https://kasuwa.agriarche.com/signup",children:p(Hr,{children:"Get Started"})}),p("a",{href:"https://play.google.com/store/apps/details?id=com.kasuwa_v2",children:O(pf,{style:{display:"flex",alignItems:"center"},children:[p("img",{style:{width:"20px"},src:"./images/google-play.png",alt:"download kasuwa app on playstore"})," ",p("span",{children:"Get on Playstore"})]})})]}),O(P0,{children:[O("div",{children:[p("img",{src:"./images/service1.svg",alt:"kasuwa farms access quick markets image"}),p("h3",{children:"Access Quick Markets"}),p("p",{children:" Connect with a diverse range of commodities and markets, streamline your operations, and drive growth for your business"})]}),O("div",{children:[p("img",{src:"./images/service5.svg",alt:"kasuwa farms wallet icon"}),p("h3",{children:"Virtual Wallet"}),p("p",{children:"  Our virtual wallet provides you with a secure, convenient, and streamlined way to manage your transactions and payments"})]}),O("div",{children:[p("img",{src:"./images/service4.svg",alt:"kasuwa farms logistics tracking icon"}),p("h3",{children:"Logistics Tracking"}),p("p",{children:"Bringing Transparency to Agriculture Supply Chain, logistics Tracking keeps you in the loop from start to finish."})]}),O("div",{children:[p("img",{src:"./images/transaction.png",alt:"kasuwa farms transaction/creadit card icon"}),p("h3",{children:"Transaction/Credit History"}),p("p",{children:"Get a clear picture of your financial history, manage your payments and credits effectively"})]}),O("div",{children:[p("img",{src:"./images/service3.svg",alt:"kasuwa farms personal data security icon"}),p("h3",{children:"Personal data security"}),p("p",{children:"We ensure your digital information is protected from unauthorized users and cyber attacks."})]}),O("div",{children:[p("img",{src:"./images/customersupport.png",alt:"kasuwa farms customer support"}),p("h3",{children:"24/7 Customer Support"}),p("p",{children:"Our dedicated customer care team is here to assist you around the clock"})]})]})]}),O(z0,{children:[p("img",{style:{position:"absolute",top:"65px",left:"0px",maxHeight:"100%",maxWidth:"400px"},src:"./images/Home Screen 1.svg",alt:"kasuwa farms mobile app"}),p("img",{src:"./images/Kasuwa Web Mockup.svg",alt:"kasuwa farms web app"})]})]}),C0=I.div`
margin-right:50px;
@media (max-width: 1000px) {
    margin-right:0px;
    }
...
img+img{
    ...
    max-width:100%;
    // margin-top:2000px;
`,N0=()=>O($0,{children:[p(A0,{children:p("img",{src:"./images/globe.svg",alt:"access realcommodities data from kasuwa farms"})}),O("div",{children:[p("h3",{children:"Access real time market information for commodities"}),p("p",{children:"Stay Ahead of the Game in Agriculture, Access Real-Time Market Information for Commodities. Stay informed and make informed decisions with up-to-date, real-time information on market trends, prices, and more."}),p("div",{children:O("a",{href:"https://kasuwa.agriarche.com/signin",children:[p("span",{children:"Make a Request "}),p("img",{style:{width:"10px",height:"15px",marginLeft:"15px"},src:"./images/arrowsmallest.png",alt:"arrow btn"})]})})]})]}),$0=I.div`
display:flex;
justify-content:space-between;
flex-wrap:wrap;
gap:12%;
...
`,cl=(e=!1)=>{const[t,n]=ve.useState(e);return[t,()=>n(i=>!i)]},T0=()=>{const[e,t]=cl(),[n,r]=cl(),[i,o]=cl(),l={display:"flex",justifyContent:"space-between",placeItems:"center",alignContent:"center",paddingBlock:"50px",marginBottom:"30px",cursor:"pointer"};return O(R0,{children:[p("h2",{children:"Frequently Asked Questions"}),O("div",{children:[O("div",{style:{borderBottom:"2px solid #6A6A6A"},children:[O("div",{style:l,onClick:t,children:[p("h3",{children:"What is Kasuwa?"}),e?p("img",{src:"./images/arrowroundedup.svg",alt:""}):p("img",{src:"./images/arrowroundedown.svg",alt:""})]}),p(lr,{children:e?p("p",{children:"The Agricultural Marketplace Kasuwa is the marketplace for agric commodities. A platform that offers payment, logistics, tracking and financial services."}):""})]}),O("div",{style:{borderBottom:"2px solid #6A6A6A"},children:[O("div",{style:l,onClick:r,children:[p("h3",{children:"How to create an order on Kasuwa?"}),n?p("img",{src:"./images/arrowroundedup.svg",alt:""}):p("img",{src:"./images/arrowroundedown.svg",alt:""})]}),p(lr,{children:n?p("p",{children:"The Agricultural Marketplace Kasuwa is the marketplace for agric commodities. A platform that offers payment, logistics, tracking and financial services."}):""})]}),O("div",{style:{borderBottom:"2px solid #6A6A6A"},children:[O("div",{style:l,onClick:o,children:[p("h3",{children:"How to delete a created order?"}),e?p("img",{src:"./images/arrowroundedup.svg",alt:""}):p("img",{src:"./images/arrowroundedown.svg",alt:""})]}),p(lr,{children:i?p("p",{children:"The Agricultural Marketplace Kasuwa is the marketplace for agric commodities. A platform that offers payment, logistics, tracking and financial services."}):""})]})]})]})},R0=I.div`
...
`,L0=()=>O(O0,{children:[p("div",{children:p("p",{children:"© Agriarche Limited. All rights reserved"})}),p("div",{children:O(I0,{children:[p("a",{href:"#",children:p("img",{src:"./images/iconfacebook.png",alt:"facebook icon"})}),p("a",{href:"#",children:p("img",{src:"./images/icontwiter.png",alt:"twitter icon"})}),p("a",{href:"#",children:p("img",{src:"./images/iconinsta.png",alt:"instagram icon"})})]})})]}),O0=I.div`
display:flex;
justify-content:space-between;
padding:50px 150px;
...
`;function M0({price:e,percentage:t,name:n}){return p(lr,{children:t>=0?O(Hs,{children:[O("div",{style:{display:"flex",alignItems:"center",justifyContent:"center"},children:[O("strong",{style:{fontSize:"25px"},children:[n," "]}),p("span",{style:{color:"#00EE76",fontSize:"20px"},children:" ▲ "}),O("span",{style:{color:"#00EE76"},children:["+",`${t}%`]})]}),O("div",{style:{fontSize:"20px"},children:["₦",e]})]}):O(Hs,{children:[O("div",{style:{display:"flex",alignItems:"center",justifyContent:"center"},children:[p("strong",{style:{fontSize:"25px"},children:n}),p("span",{style:{color:"#F43249",fontSize:"20px"},children:" ▼  "}),p("span",{style:{color:"#F43249"},children:`${t}%`})]}),O("div",{style:{fontSize:"20px"},children:["₦",e]})]})})}const Hs=I.div`
display:flex;
flex-direction:column;
// background:red;
...
`;function j0(){const[e,t]=ve.useState([]),[n,r]=ve.useState({});function i(){fetch("https://kasuwaapp7.onrender.com/public").then(o=>o.json()).then(o=>{let l=o[0].commodities,a=o[1].commodities;const u=(w,x)=>((w-x)/x*100).toFixed(2);let c=[],g=[];for(let w=0;w<l.length;w++){let x=!1;for(let k=0;k<a.length;k++)if(l[w].name==a[k].name){if(x)break;c[a[k].name]=u(l[w].price,a[k].price),g[a[k].name]=l[w].price,x=!0}}console.log("Array3:",c),t(g),console.log("arr4",g),console.log("c0mmodity:",n);let m=l.map(w=>w.price),h=a.map(w=>w.price);console.log(m),console.log(h),r(c)}).catch(o=>{console.log(o)})}return ve.useEffect(()=>{i()},[]),p(F0,{commodities:e,commodityPercentage:n,children:Object.keys(n).map(o=>p(M0,{name:o,price:e[o],percentage:n[o]}))})}let D0=Um`
    0% {
...
`;function U0(){return O("div",{children:[p(j0,{}),p(Wm,{}),p(Hm,{}),p(bm,{}),p(S0,{}),p(r0,{}),p(s0,{}),p(p0,{}),p(N0,{}),p(T0,{}),p(L0,{})]})}dl.createRoot(document.getElementById("root")).render(p(Vn.StrictMode,{children:p(U0,{})}));
