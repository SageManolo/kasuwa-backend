...
`,Hm=()=>h("div",{children:L(Vm,{children:[L("h1",{children:["A B2B ",h("span",{children:"Marketplace"})," for Agric Commodities "]}),h("p",{children:"Sell your commodities to local and international buyers | Buy commodities from anywhere in the world"}),L("div",{children:[h("a",{href:"https://kasuwa.agriarche.com/signup",children:h(Hr,{children:"create Account"})}),h("a",{href:"https://play.google.com/store/apps/details?id=com.kasuwa_v2",children:L(pf,{style:{display:"flex",alignItems:"center"},children:[h("img",{src:"./images/google-play.png",alt:"download kasuwa app on playstore"})," ",h("span",{children:"Get on Playstore"})," "]})})]}),h("img",{src:"./images/globe.png",alt:"kasuwa around the globe"})]})}),Vm=I.header`
...
`,Wm=()=>L(Qm,{children:[h("img",{src:"./images/KASSSS 2.png",alt:"kasuwa farms logo"}),L(Gm,{children:[h("a",{href:"https://kasuwa.agriarche.com/signin",children:h(Ym,{children:"sign in"})}),h("a",{href:"https://kasuwa.agriarche.com/signup",children:h(Km,{children:"create Account"})})]})]}),Qm=I.nav`
  background: var(--color-white);
...
`;function qm(){const[e,t]=he.useState(0),[n,r]=he.useState("one");function i(u){t(u)}const o=I.div`
    display: flex;
    width: fit-content;
...
*,*::after, *::before{
box-sizing: border-box;
}`,L(c0,{children:[L(d0,{children:[h("h2",{children:"Ready To Get Started"}),h("p",{children:"Get started now and experience the benefits of quick, easy and secure transactions all in one place"})]}),L(f0,{children:[L(Us,{children:[h("img",{src:"./images/sellerconnect.svg",alt:"kasuwa farms sellersconnect"}),h("h5",{children:"Sign up as a Seller"}),h("p",{children:"Sign up as a seller on our B2B marketplace and connect with buyers from around the world"}),h(Fs,{children:L("a",{href:"https://kasuwa.agriarche.com/signup",children:[h("sapn",{children:"Sign Up"}),h("img",{style:{width:"11px",height:"7px"},src:"./images/arrow.svg",alt:"arrow btn link to signup seller"})]})})]}),L(Us,{children:[h("img",{src:"./images/buyerconnect.svg",alt:"buyersconnect"}),h("h5",{children:"Sign up as a Buyer"}),h("p",{children:"Get Direct Access to Agric commodities on our B2B Agric Marketplace and enjoy a seamless and efficient trading"}),h(Fs,{children:L("a",{href:"https://kasuwa.agriarche.com/signup",children:[h("sapn",{children:"Sign Up"}),h("img",{style:{width:"11px",height:"7px"},src:"./images/arrow.svg",alt:"arrow btn link to signup as buyer"})]})})]})]})]})),c0=I.div`
margin:400px 140px auto 140px;
width:auto;
height:fit-content;
...
`;const p0=()=>L(h0,{children:[h("h2",{children:"Our Partners"}),L(m0,{children:[h(g0,{style:{width:"182px",height:"57px"},src:"./images/logo2.svg",alt:"united agency for international development logo"}),h(v0,{style:{width:"150px",height:"57px"},src:"./images/logomcn.svg",alt:"mercy corps logo"}),h(y0,{style:{width:"203px",height:"57px"},src:"./images/logoifdc.svg",alt:"IFDC logo"}),h(x0,{style:{width:"162px",height:"70px"},src:"./images/logo1.svg",alt:"NCX logo"}),h(w0,{style:{width:"73px",height:"88px"},src:"./images/logofcmb.svg",alt:"FCMB logo"}),h(S0,{style:{width:"149px",height:"82px"},src:"./images/logofeedthefuture.svg",alt:"feed the futere logo"})]})]}),h0=I.div`
text-align:center;
margin:200px auto;
width:100%;
...
`,k0=()=>L(E0,{children:[L(C0,{children:[L(Lo,{children:[" Are You an ",h(Bs,{children:"Aggregator"}),h("br",{}),"or a ",h(Bs,{children:"Seller"})," of Agric",h("br",{})," Commodities?"]}),L(_0,{children:[h("a",{href:"https://kasuwa.agriarche.com/signup",children:h(Hr,{children:"Get Started"})}),h("a",{href:"https://play.google.com/store/apps/details?id=com.kasuwa_v2",children:L(pf,{style:{display:"flex",alignItems:"center"},children:[h("img",{style:{width:"20px"},src:"./images/google-play.png",alt:"download kasuwa app on playstore"})," ",h("span",{children:"Get on Playstore"})]})})]}),L(P0,{children:[L("div",{children:[h("img",{src:"./images/service1.svg",alt:"kasuwa farms access quick markets image"}),h("h3",{children:"Access Quick Markets"}),h("p",{children:" Connect with a diverse range of commodities and markets, streamline your operations, and drive growth for your business"})]}),L("div",{children:[h("img",{src:"./images/service5.svg",alt:"kasuwa farms wallet icon"}),h("h3",{children:"Virtual Wallet"}),h("p",{children:"  Our virtual wallet provides you with a secure, convenient, and streamlined way to manage your transactions and payments"})]}),L("div",{children:[h("img",{src:"./images/service4.svg",alt:"kasuwa farms logistics tracking icon"}),h("h3",{children:"Logistics Tracking"}),h("p",{children:"Bringing Transparency to Agriculture Supply Chain, logistics Tracking keeps you in the loop from start to finish."})]}),L("div",{children:[h("img",{src:"./images/transaction.png",alt:"kasuwa farms transaction/creadit card icon"}),h("h3",{children:"Transaction/Credit History"}),h("p",{children:"Get a clear picture of your financial history, manage your payments and credits effectively"})]}),L("div",{children:[h("img",{src:"./images/service3.svg",alt:"kasuwa farms personal data security icon"}),h("h3",{children:"Personal data security"}),h("p",{children:"We ensure your digital information is protected from unauthorized users and cyber attacks."})]}),L("div",{children:[h("img",{src:"./images/customersupport.png",alt:"kasuwa farms customer support"}),h("h3",{children:"24/7 Customer Support"}),h("p",{children:"Our dedicated customer care team is here to assist you around the clock"})]})]})]}),L(z0,{children:[h("img",{style:{position:"absolute",top:"65px",left:"0px",maxHeight:"100%",maxWidth:"400px"},src:"./images/Home Screen 1.svg",alt:"kasuwa farms mobile app"}),h("img",{src:"./images/Kasuwa Web Mockup.svg",alt:"kasuwa farms web app"})]})]}),C0=I.div`
margin-right:50px;
@media (max-width: 1000px) {
    margin-right:0px;
    }
...
img+img{
    ...
    max-width:100%;
    // margin-top:2000px;
`,N0=()=>L($0,{children:[h(A0,{children:h("img",{src:"./images/globe.svg",alt:"access realcommodities data from kasuwa farms"})}),L("div",{children:[h("h3",{children:"Access real time market information for commodities"}),h("p",{children:"Stay Ahead of the Game in Agriculture, Access Real-Time Market Information for Commodities. Stay informed and make informed decisions with up-to-date, real-time information on market trends, prices, and more."}),h("div",{children:L("a",{href:"https://kasuwa.agriarche.com/signin",children:[h("span",{children:"Make a Request "}),h("img",{style:{width:"10px",height:"15px",marginLeft:"15px"},src:"./images/arrowsmallest.png",alt:"arrow btn"})]})})]})]}),$0=I.div`
display:flex;
justify-content:space-between;
flex-wrap:wrap;
gap:12%;
...
`,cl=(e=!1)=>{const[t,n]=he.useState(e);return[t,()=>n(i=>!i)]},T0=()=>{const[e,t]=cl(),[n,r]=cl(),[i,o]=cl(),l={display:"flex",justifyContent:"space-between",placeItems:"center",alignContent:"center",paddingBlock:"50px",marginBottom:"30px",cursor:"pointer"};return L(R0,{children:[h("h2",{children:"Frequently Asked Questions"}),L("div",{children:[L("div",{style:{borderBottom:"2px solid #6A6A6A"},children:[L("div",{style:l,onClick:t,children:[h("h3",{children:"What is Kasuwa?"}),e?h("img",{src:"./images/arrowroundedup.svg",alt:""}):h("img",{src:"./images/arrowroundedown.svg",alt:""})]}),h(Nn,{children:e?h("p",{children:"The Agricultural Marketplace Kasuwa is the marketplace for agric commodities. A platform that offers payment, logistics, tracking and financial services."}):""})]}),L("div",{style:{borderBottom:"2px solid #6A6A6A"},children:[L("div",{style:l,onClick:r,children:[h("h3",{children:"How to create an order on Kasuwa?"}),n?h("img",{src:"./images/arrowroundedup.svg",alt:""}):h("img",{src:"./images/arrowroundedown.svg",alt:""})]}),h(Nn,{children:n?h("p",{children:"The Agricultural Marketplace Kasuwa is the marketplace for agric commodities. A platform that offers payment, logistics, tracking and financial services."}):""})]}),L("div",{style:{borderBottom:"2px solid #6A6A6A"},children:[L("div",{style:l,onClick:o,children:[h("h3",{children:"How to delete a created order?"}),e?h("img",{src:"./images/arrowroundedup.svg",alt:""}):h("img",{src:"./images/arrowroundedown.svg",alt:""})]}),h(Nn,{children:i?h("p",{children:"The Agricultural Marketplace Kasuwa is the marketplace for agric commodities. A platform that offers payment, logistics, tracking and financial services."}):""})]})]})]})},R0=I.div`
...
`;function M0({price:e,percentage:t,name:n}){return h(Nn,{children:t>=0?L(Hs,{children:[L("div",{style:{display:"flex",alignItems:"center",justifyContent:"center"},children:[L("strong",{style:{fontSize:"25px"},children:[n," "]}),h("span",{style:{color:"#00EE76",fontSize:"20px"},children:" ▲ "}),L("span",{style:{color:"#00EE76"},children:["+",`${t}%`]})]}),L("div",{style:{fontSize:"20px"},children:["₦",e]})]}):L(Hs,{children:[L("div",{style:{display:"flex",alignItems:"center",justifyContent:"center"},children:[h("strong",{style:{fontSize:"25px"},children:n}),h("span",{style:{color:"#F43249",fontSize:"20px"},children:" ▼  "}),h("span",{style:{color:"#F43249"},children:`${t}%`})]}),L("div",{style:{fontSize:"20px"},children:["₦",e]})]})})}const Hs=I.div`
display:flex;
flex-direction:column;
// background:red;
...
`;function j0(){const[e,t]=he.useState([]),[n,r]=he.useState({}),[i,o]=he.useState(!0);function l(){fetch("https://kasuwaapp7.onrender.com/public").then(a=>a.json()).then(a=>{let u=a[0].commodities,c=a[1].commodities;const g=(w,x)=>((w-x)/x*100).toFixed(2);let m=[],p=[];for(let w=0;w<u.length;w++){let x=!1;for(let S=0;S<c.length;S++)if(u[w].name==c[S].name){if(x)break;m[c[S].name]=g(u[w].price,c[S].price),p[c[S].name]=u[w].price,x=!0}}console.log("Array3:",m),t(p),console.log("arr4",p),console.log("c0mmodity:",n),u.map(w=>w.price),c.map(w=>w.price),r(m),o(!1)}).catch(a=>{console.log(a)})}return he.useEffect(()=>{l()},[]),h(Nn,{children:L(F0,{commodities:e,commodityPercentage:n,children:[Object.keys(n).map(a=>h(M0,{name:a,price:e[a],percentage:n[a]})),L("div",{style:{fontSize:"30px"},children:[i&&"Loading..."," "]}),L("div",{style:{fontSize:"30px"},children:[i&&"Loading..."," "]}),L("div",{style:{fontSize:"30px"},children:[i&&"Loading..."," "]}),L("div",{style:{fontSize:"30px"},children:[i&&"Loading..."," "]})]})})}let D0=Um`
    0% {
...
`;function U0(){return L("div",{children:[h(j0,{}),h(Wm,{}),h(Hm,{}),h(bm,{}),h(k0,{}),h(r0,{}),h(s0,{}),h(p0,{}),h(N0,{}),h(T0,{}),h(L0,{})]})}dl.createRoot(document.getElementById("root")).render(h(Wn.StrictMode,{children:h(U0,{})}));
